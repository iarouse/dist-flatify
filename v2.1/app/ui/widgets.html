            ...
            <section class="panel panel-box">
                ...
                <div class="panel-bottom bg-reverse">
                    <ul class="list-justified text-center">
                        <li>
                            <p class="size-h2 text-info"><i class="wi wi-cloudy"></i></p>
                            <p class="text-muted">Tuesday</p>
                        </li>
                        <li>
                            <p class="size-h2 text-warning"><i class="wi wi-day-thunderstorm"></i></p>
                            <p class="text-muted">Wednesday</p>
                        </li>
                        <li>
                            <p class="size-h2 text-danger"><i class="wi wi-day-snow"></i></p>
                            <p class="text-muted">Thursday</p>
                        </li>
                        <li>
                            <p class="size-h2 text-success"><i class="wi wi-day-sunny"></i></p>
