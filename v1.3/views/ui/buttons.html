    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <dl class="dl-horizontal">
                <dt>Lined version</dt>
                <dd>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-default">Default</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-primary">Primary</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-success">Success</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-info">Info</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-warning">Warning</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-danger">Danger</button>
                </dd>

                <div class="divider"></div>
                <dt>Filled-in version</dt>
                <dd>
                    ...
                    <!-- <button type="button" class="btn btn-w-md btn-gap-v btn-inverse">Inverse</button> -->
                </dd>
...
<!--                 <div class="divider"></div>
                ...
                <dd>
                    ...
                    <button type="button" class="btn btn-w-md btn-gap-v btn-round btn-inverse">Inverse</button>
                </dd> -->
            </dl> 
            ...
            <dl class="dl-horizontal">
                <dt>Lined version</dt>
                <dd>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-default" disabled>Default</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-primary" disabled>Primary</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-success" disabled>Success</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-info" disabled>Info</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-warning" disabled>Warning</button>
                    <button type="button" class="btn btn-w-md btn-gap-v btn-line-danger" disabled>Danger</button>
                </dd>
                ...
                <dd>
                    ...
                    <!-- <button type="button" class="btn btn-w-md btn-gap-v btn-inverse" disabled>Inverse</button> -->
                </dd>
...
<!--                 <div class="divider"></div>
                ...
                <dd>
                    ...
                    <button type="button" class="btn btn-w-md btn-gap-v btn-round btn-inverse" disabled>Inverse</button>
                </dd> -->
            </dl>
        </div>
    </div>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-twitter"><i class="fa fa-twitter"></i></a>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-facebook"><i class="fa fa-facebook"></i></a>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-google-plus"><i class="fa fa-google-plus"></i></a>
                    </p>
                    <p>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-primary"><i class="fa fa-bell"></i></a>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-success"><i class="fa fa-cloud"></i></a>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-info"><i class="fa fa-inbox"></i></a>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-warning"><i class="fa fa-mail-reply"></i></a>
                        <a href="javascript:;" class="btn-icon-round btn-icon-round-sm bg-danger"><i class="fa fa-rocket"></i></a>
                    </p>
                </div>
            </div>
